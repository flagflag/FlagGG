...
if (NOT IN_TRY_COMPILE)
    if (NOT SAVED_EMSCRIPTEN_ROOT_PATH)
        ...
        message (${EMSCRIPTEN_ROOT_PATH}/emcc${TOOL_EXT})
...
if (NOT EMSCRIPTEN_EMCC_VERSION)
    message ("${EMSCRIPTEN_ROOT_PATH}/emcc${TOOL_EXT} --version RESULT_VARIABLE EXIT_CODE OUTPUT_VARIABLE EMSCRIPTEN_EMCC_VERSION ERROR_QUIET OUTPUT_STRIP_TRAILING_WHITESPACE")
