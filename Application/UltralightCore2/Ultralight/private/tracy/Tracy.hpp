...
#if defined(TRACY_PROFILE_PERFORMANCE)
#if defined(ULTRALIGHT_MODULE_ULTRALIGHTCORE)
#define ProfiledZone ZoneScopedC(tracy::Color::BlueViolet)
#elif defined(ULTRALIGHT_MODULE_WEBCORE)
#define ProfiledZone ZoneScopedC(tracy::Color::Aquamarine)
#elif defined(ULTRALIGHT_MODULE_ULTRALIGHT)
#define ProfiledZone ZoneScopedC(tracy::Color::LightGoldenrod1)
#elif defined(ULTRALIGHT_MODULE_APPCORE)
#define ProfiledZone ZoneScopedC(tracy::Color::OrangeRed1)
#else
#define ProfiledZone ZoneScoped
#endif
#else
#define ProfiledZone 
#endif
...
#ifndef TRACY_CALLSTACK_DEPTH
#define TRACY_CALLSTACK_DEPTH 8
#endif

#define ProfileAlloc(ptr, size, name) TracyAllocNS(ptr, size, TRACY_CALLSTACK_DEPTH, name)
#define ProfileFree(ptr, name) TracyFreeNS(ptr, TRACY_CALLSTACK_DEPTH, name)
#else
