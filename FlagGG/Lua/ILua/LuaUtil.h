...
FlagGG_API bool GetGameEvent(lua_State* L, const String& eventName);
...
bool Call(lua_State *L, const String& eventName, Args&& ... args)
{
...
#define LUA_API_PROXY(className, funcName, luaFuncName) FlagGG::LuaAPIBinder<className, &className::funcName>::Proxy(luaFuncName)
