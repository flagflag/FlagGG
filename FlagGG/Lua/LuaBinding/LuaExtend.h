...
FlagGG_API int luaex_pushusertyperef(lua_State* L, const char* userType, RefCounted* ref);

FlagGG_API void* luaex_tousertype(lua_State* L, int idx, const char* userType);

FlagGG_API bool luaex_juedge_inherit(lua_State* L, const String& type, const String& superClass);
