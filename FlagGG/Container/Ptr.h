...
public:
	...
	void Swap(SharedPtr& rhs) { FlagGG::Swap(ptr_, rhs.ptr_); }
...
public:
	...
	void Swap(UniquePtr& up) { FlagGG::Swap(ptr_, up.ptr_); }
...
namespace boost
{
	template<class T> inline T* get_pointer(FlagGG::SharedPtr<T>& sharedPtr)
	{
