...
template <class T> typename List<T>::ConstIterator begin(const List<T>& v) { return v.Begin(); }

template <class T> typename List<T>::ConstIterator end(const List<T>& v) { return v.End(); }

template <class T> typename List<T>::Iterator begin(List<T>& v) { return v.Begin(); }

template <class T> typename List<T>::Iterator end(List<T>& v) { return v.End(); }
