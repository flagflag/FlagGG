...
template <class T> typename PODVector<T>::ConstIterator begin(const PODVector<T>& v) { return v.Begin(); }

template <class T> typename PODVector<T>::ConstIterator end(const PODVector<T>& v) { return v.End(); }

template <class T> typename PODVector<T>::Iterator begin(PODVector<T>& v) { return v.Begin(); }

template <class T> typename PODVector<T>::Iterator end(PODVector<T>& v) { return v.End(); }
