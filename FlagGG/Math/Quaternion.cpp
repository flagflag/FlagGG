...
namespace FlagGG
{
	namespace Math
	{
		...
		{
			return FlagGG::Math::Equals(w_, rhs.w_) && FlagGG::Math::Equals(x_, rhs.x_) && FlagGG::Math::Equals(y_, rhs.y_) && FlagGG::Math::Equals(z_, rhs.z_);
		}

		bool Quaternion::IsNaN() const { return FlagGG::Math::IsNaN(w_) || FlagGG::Math::IsNaN(x_) || FlagGG::Math::IsNaN(y_) || FlagGG::Math::IsNaN(z_); }
		...
		Container::String Quaternion::ToString() const
		{
