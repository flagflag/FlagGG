...
public:
    ...
    Color GammaToLinear() const { return Color(FlagGG::Pow(r_, 2.2f), FlagGG::Pow(g_, 2.2f), FlagGG::Pow(b_, 2.2f), a_); }

    Color LinearToGamma() const { return Color(FlagGG::Pow(r_, 1.0f / 2.2f), FlagGG::Pow(g_, 1.0f / 2.2f), FlagGG::Pow(b_, 1.0f / 2.2f), a_); }
    ...
    /// Transparent white color (white with no alpha).
