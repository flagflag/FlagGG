...
static SDlgData g_dialogRC =
{
    ...
    {BS_DEFPUSHBUTTON|WS_CHILD|WS_VISIBLE|WS_TABSTOP/*|WS_DISABLED*/,						     		0,	66,	113,50,14,	IDC_CRYASSERT_BUTTON_IGNORE,		0xFFFF,0x0080,DLG_ITEM_TEXT_12,	0},
    {BS_PUSHBUTTON|WS_CHILD|WS_VISIBLE|WS_TABSTOP/*|WS_DISABLED*/,									    0,	120, 113,50,14,	IDC_CRYASSERT_BUTTON_IGNORE_ALL,0xFFFF,0x0080,DLG_ITEM_TEXT_15,	0},
...
static char gs_szMessage[10240];
...
void CryAssertTrace(const char *_pszFormat,...)
{
    if(!gs_bIgnoreAllAsserts)
    {
        ...
        else
        {
            ...
            vsprintf_s(gs_szMessage, 10240, _pszFormat,args);
            va_end(args);
        }
    }
}
