...
static_assert(ARRAY_COUNT(REVERSE_Z_MAPPING) == COMPARISON_MAX);

UInt32 VERTEX_ELEMENT_TYPE_SIZE[] =
{
	sizeof(Int32),
	sizeof(float),
	2 * sizeof(float),
...
static_assert(ARRAY_COUNT(VERTEX_ELEMENT_TYPE_SIZE) == MAX_VERTEX_ELEMENT_TYPE);

FlagGG_API const char* VERTEX_ELEMENT_SEM_NAME[] =
{
	"POSITION",
	"NORMAL",
	"BINORMAL",
...
static_assert(ARRAY_COUNT(VERTEX_ELEMENT_SEM_NAME) == MAX_VERTEX_ELEMENT_SEMANTIC);
...
const UInt32 DRAWABLE_UNDEFINED = 0x0;
const UInt32 DRAWABLE_STATICMESH = 0x1;
const UInt32 DRAWABLE_SKELETONMESH = 0x2;
const UInt32 DRAWABLE_TERRAIN = 0x4;
const UInt32 DRAWABLE_PARTICLE = 0x8;
const UInt32 DRAWABLE_GEOMETRY = DRAWABLE_STATICMESH | DRAWABLE_SKELETONMESH | DRAWABLE_TERRAIN | DRAWABLE_PARTICLE;
const UInt32 DRAWABLE_LIGHT = 0x10;
const UInt32 DRAWABLE_PROBE = 0x20;
const UInt32 DRAWABLE_ANY = 0xff;
const UInt32 DEFAULT_VIEWMASK = FlagGG::F_MAX_UNSIGNED;
const UInt32 DEFAULT_LIGHTMASK = FlagGG::F_MAX_UNSIGNED;
const UInt32 DEFAULT_SHADOWMASK = FlagGG::F_MAX_UNSIGNED;
const UInt32 DEFAULT_PROBEMASK = FlagGG::F_MAX_UNSIGNED;
