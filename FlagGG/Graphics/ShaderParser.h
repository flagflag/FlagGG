...
namespace FlagGG
{
	namespace Graphics
	{
		...
		protected:
			...
			bool ParseVertex(Container::PODVector<char>& varyingDef, Container::Vector<Container::String>& varName, Container::String& prepareDefines);
