...
enum RenderPassType : UInt32
{
	...
	RENDER_PASS_TYPE_FORWARD_WATER,
...
enum BufferBind : UInt8
{
	...
	BUFFER_BIND_RASTE_READ = 0x8,      // 在vs or ps中作为纹理单位采样
	BUFFER_BIND_COMPUTE_READ  = 0x10,  // 在cs中作为纹理单位采样
	BUFFER_BIND_COMPUTE_WRITE = 0x20,  // 在cs中可写
	BUFFER_BIND_DRAW_INDIRECT = 0x40,
};
