...
public:
	...
	void ToString(String& result) override;
	void ToBuffer(SharedArrayPtr<char>& buffer, UInt32& bufferSize) override;
...
private:
	PODVector < SimpleBuffer > buffers_;
...
typedef SharedPtr<NetBuffer> NetBufferPtr;
