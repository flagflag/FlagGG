...
// BEGIN_UNITY @jonathanma For ScriptingObjectPtr
...
WIN_EXPORT void YGSetManagedObject(YGNodeRef node, ScriptingObjectPtr managedObject);
// END_UNITY
...
WIN_EXPORT float YGNodeGetComputedFlexBasis(const YGNodeRef node);
...
// BEGIN_UNITY @jonathanma Added managed object handle for callbacks invocation
// This function needs to be defined outside of the extern C block because it returns a ScriptingObjectPtr 
WIN_EXPORT ScriptingObjectPtr YGGetManagedObject(const YGNodeRef node);
// END_UNITY
