...
static void AddOpAssignToDest(bstring glsl, SHADER_VARIABLE_TYPE eSrcType, uint32_t ui32SrcElementCount, SHADER_VARIABLE_TYPE eDestType, uint32_t ui32DestElementCount, const char* szAssignmentOp, int& numParenthesis, bool allowReinterpretCast = true)
{
    numParenthesis = 0;
...
void ToMetal::AddOpAssignToDestWithMask(const Operand* psDest,
    SHADER_VARIABLE_TYPE eSrcType, uint32_t ui32SrcElementCount, const char* szAssignmentOp, int& numParenthesis, uint32_t ui32CompMask)
{
    ...
    AddOpAssignToDest(glsl, eSrcType, ui32SrcElementCount, eDestType, ui32DestElementCount, szAssignmentOp, numParenthesis, psContext->psShader->ui32MajorVersion > 3);
}

void ToMetal::AddAssignToDest(const Operand* psDest,
    SHADER_VARIABLE_TYPE eSrcType, uint32_t ui32SrcElementCount, int& numParenthesis)
{
    AddOpAssignToDestWithMask(psDest, eSrcType, ui32SrcElementCount, "=", numParenthesis, OPERAND_4_COMPONENT_MASK_ALL);
}
...
UNIT_TEST_SUITE(ToMetalInstructionTests)
{
    static void TestAddOpAssignToDest(const char* expect, SHADER_VARIABLE_TYPE srcType, uint32_t srcDim, SHADER_VARIABLE_TYPE dstType, uint32_t dstDim)
    {
        ...
        int parenthesis = 0;
        AddOpAssignToDest(actual, srcType, srcDim, dstType, dstDim, "=", parenthesis);
