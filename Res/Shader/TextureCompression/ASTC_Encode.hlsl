...
#include "Shader/TextureCompression/ASTC_Table.hlsl"
#include "Shader/TextureCompression/ASTC_IntegerSequenceEncoding.hlsl"
	...
	uint Gidx : SV_GroupIndex)			// group里的thread坐标展开后的索引
{
	...
	OutTexture[DTid.xy] = encode_block(texels);
}
